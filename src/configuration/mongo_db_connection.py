...
class MongoDBClient:
    ...
    client = None  # Shared MongoClient instance across all MongoDBClient instances
                   ...
                   # without client = None -- Every time you create MongoDBClient(), it would create a new MongoDB connection — bad for performance and unnecessary.

    def __init__(self, database_name: str = DATABASE_NAME) -> None: #give datasbase name, if not given it will by default take DATABASE_NAME
        """
        ...
        try:
            ...
            # python lets you add attributes to self dynamically 
