...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try: 
            ...
            dataframe = my_data.export_collection_as_dataframe(collection_name = self.data_ingesstion_config.collection_name)

            logging.info(f"shape of the dataframe: {dataframe.shape}")

            feature_store_file_path = self.data_ingestion_config.feature_store_file_path

            dir_path = os.path.dirname(feature_store_file_path) #extracts the directory name
